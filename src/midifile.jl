...
@deprecate readMIDIFile(filename::AbstractString) FileIO.load(filename)
...
@deprecate writeMIDIFile(filename::AbstractString, notes::Notes) FileIO.save(filename, notes)
