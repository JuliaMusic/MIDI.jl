@testset "Metaevent" begin
    validtestvalues = [
        ...
        ([0x00, 0xFF, 0x03, 0x04, 0x11, 0x21, 0x53, 0x1F], MIDI.TrackName(0, 0x03, [0x11, 0x21, 0x53, 0x1F])),
        ([0x00, 0xFF, 0x05, 0x06, 0x25, 0x61, 0x23, 0x5B, 0x00, 0x02], MIDI.Lyric(0, 0x05, [0x25, 0x61, 0x23, 0x5B, 0x00, 0x02]))
    ]
